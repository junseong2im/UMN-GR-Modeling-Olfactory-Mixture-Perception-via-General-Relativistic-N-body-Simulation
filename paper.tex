...
Limitations include the small dataset size (360 pairs), the absence of identical-protocol comparison with Snitz et al. (2013), and the weak effect sizes ($|r| < 0.15$) in the interpretability analysis. The multi-restart dependency, while empirically justified, increases total training cost linearly with restart count. Future directions include larger datasets, deeper interpretability via attention on learned trajectories and causal intervention experiments, simulation-GNN ensembles, and concentration-aware models.
